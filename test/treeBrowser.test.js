...
describe("title test", () => {
  it("Adding workers", async () =>  {
    ...
    expect(wrapper.findAll("div.node-info")[1].text()).toEqual('managerCost: $300')
    ...
    expect(wrapper.findAll("div.node-info")[1].text()).toEqual('managerCost: $2100')
    ...
    expect(wrapper.findAll("div.node-info")[1].text()).toEqual('managerCost: $1100')
